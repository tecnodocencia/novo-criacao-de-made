...
- [Sessão 2026-09-09: investigação modal vitória/níveis](sessao_2026-09-09_investigacao_niveis_modal.md) — #modal-solution é estático em index.html (partial modals.html não existe/não carrega); HTML morto de #level-info-repeticao em index.html; troca por nível já é literal-por-posição e uniforme nos 4 níveis (suspeita de swap no nível 4 é infundada)
- [Sessão 2026-09-22: editor reestruturado para 3 telas](sessao_2026-09-22_editor_3_telas.md) — showStep→showPhase+showBlock, editingBlock novo no state, hub 2x2 de blocos coloridos, creator-step-4 preservado intacto, markup morto de #view-creator em index.html (não é renderizado, cuidado ao grepar)
- [Sessão 2026-09-22: paleta colorida no chrome administrativo](sessao_2026-09-22_paleta_colorida.md) — verde/âmbar/azul/rosa aplicados em login, sidebar, dashboard, biblioteca, configurações, modais; green-600 (novo) coexiste com emerald-600 (legado) de propósito; estado vazio do dashboard novo; bug de setAuthMode corrigido
