...
- [Mapa de arquivos e módulos](arquivos_modulos.md) — onde cada parte do MADE vive no repo (SPA de 1 página)
...
- [Funções centrais do app.js](funcoes_centrais.md) — fluxo editor → revisão → testar → player, nomes a preservar
